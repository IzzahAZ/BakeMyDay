...
<html>
  ...
  <head>
    <title> Contact | Bake My Day </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Cakes Zone </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Bake My Day </span>?</strong>
     <br>
...
<footer>
  <h6 style="color: black">Bake My Day, 2020. Cheras, Kuala Lumpur.<h6 style="color: black">Our ingredients are high quality, each cake is carefully made with only the finest.<h6 style="color: black">Copyright © 2021</h6>
</footer>
